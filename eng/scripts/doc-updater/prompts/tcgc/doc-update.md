...
You have access to the **@doc-example-generator** skill. When you need to create or update `<ClientTabs>` code examples, invoke this skill — it will compile TypeSpec, run all language emitters, and produce verified code for each language tab. Do NOT hand-write language code blocks.
