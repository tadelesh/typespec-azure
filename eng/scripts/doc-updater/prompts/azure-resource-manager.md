...
- **Getting-started and how-to guides** reflect current library API: replace deprecated syntax, fix incorrect information, and add coverage for any critical scenario service teams need that is missing.
