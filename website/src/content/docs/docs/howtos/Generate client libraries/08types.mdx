...
Use `DocumentationMode.append` to add SDK-specific notes to the existing service documentation instead of replacing it:
...
@clientDoc("\nNote: Widget IDs are globally unique and case-sensitive.", DocumentationMode.append)
model Widget {
  @doc("The unique identifier")
  @clientDoc("\nMust be a valid UUID format.", DocumentationMode.append)
  id: string;
  ...
  @clientDoc("\nSupported values: red, green, blue.", DocumentationMode.append)
  color: string;
}
```
...
class Widget(_Model):
    ...
    Note: Widget IDs are globally unique and case-sensitive.

    :ivar id: The unique identifier

     Must be a valid UUID format. Required.
    :vartype id: str
    :ivar name: The widget name. Required.
    :vartype name: str
    :ivar color: The widget color

     Supported values: red, green, blue. Required.
    :vartype color: str
    """
...
```go
// Widget - A widget resource
// Note: Widget IDs are globally unique and case-sensitive.
type Widget struct {
	// REQUIRED; The widget color
	// Supported values: red, green, blue.
	Color *string
