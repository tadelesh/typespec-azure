...
In Java, `@Azure.ClientGenerator.Core.Legacy.flattenProperty` have no effect on generated libraries.
...
Use `@Azure.ClientGenerator.Core.Legacy.hierarchyBuilding` when you need to represent complex inheritance hierarchies in discriminated models where:
