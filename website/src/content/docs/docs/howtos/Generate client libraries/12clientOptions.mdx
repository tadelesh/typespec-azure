...
| --------- | ----------------------------- | --------------------------------------------------------------------------------------- |
| `target`  | `unknown`                     | The target model, operation, enum, or property to apply the option to                   |
| `name`    | `valueof string`              | The name of the option to set                                                           |
| `value`   | `valueof unknown`             | The value for the option (typically string, boolean, or number)                         |
| `scope`   | `valueof string` (optional)   | The target language scope. **Required** - omitting scope produces an additional warning |
