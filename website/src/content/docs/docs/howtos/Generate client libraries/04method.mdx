...
The `@scope` decorator allows you to limit an operation or model property to specific language emitters. By default, all operations are generated for all languages. With `@scope`, you can include or exclude specific languages.
...
// This operation is generated for all languages except C#
@scope("!csharp")
@route("/all-except-csharp")
@get
op getAllExceptCsharp(): void;

// This operation is only generated for Go
@scope("go")
@route("/go-only")
@get
op getGoOnly(): void;

// This operation is generated for all languages (default behavior)
@route("/all-languages")
@get
op getAllLanguages(): void;

model ScopedModel {
  commonProp: string;

  // This property only appears in the Python SDK
  @scope("python")
...
```python
# getAllExceptCsharp and getAllLanguages are generated
# getGoOnly is NOT generated (scoped to Go only)

class ScopeDemo:
    def get_all_except_csharp(self, **kwargs: Any) -> None: ...
    def get_all_languages(self, **kwargs: Any) -> None: ...

class ScopedModel:
    common_prop: str = rest_field(name="commonProp")
    python_only_prop: Optional[str] = rest_field(name="pythonOnlyProp")
```

```csharp
// getAllExceptCsharp is NOT generated (excluded from C#)
// getGoOnly is NOT generated (scoped to Go only)

public class ScopeDemo
{
    public virtual Response GetAllLanguages(CancellationToken cancellationToken = default);
}

public class ScopedModel
{
    public string CommonProp { get; set; }
    // pythonOnlyProp is NOT generated (scoped to Python only)
}
```
...
export class ScopeDemo {
  async getAllExceptCsharp(): Promise<void>;
...
public final class ScopeDemo {
    public void getAllExceptCsharp();
    public void getAllLanguages();
}
```

```go
// getGoOnly and getAllLanguages are generated
// getAllExceptCsharp is generated (Go is not excluded)

func (client *ScopeDemoClient) GetAllExceptCsharp(ctx context.Context, options *ScopeDemoClientGetAllExceptCsharpOptions) (ScopeDemoClientGetAllExceptCsharpResponse, error)
func (client *ScopeDemoClient) GetGoOnly(ctx context.Context, options *ScopeDemoClientGetGoOnlyOptions) (ScopeDemoClientGetGoOnlyResponse, error)
func (client *ScopeDemoClient) GetAllLanguages(ctx context.Context, options *ScopeDemoClientGetAllLanguagesOptions) (ScopeDemoClientGetAllLanguagesResponse, error)
```

</ClientTabs>

The scope parameter supports the same patterns as other TCGC decorators:
...
The `@responseAsBool` decorator indicates that a HEAD operation should return a boolean value. When applied:
...
```go
func (client *ResourceServiceClient) Exists(ctx context.Context, name string, options *ResourceServiceClientExistsOptions) (ResourceServiceClientExistsResponse, error)
```
