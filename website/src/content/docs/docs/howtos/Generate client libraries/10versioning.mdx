...
The `@clientApiVersions` decorator lets you specify additional API versions that a client should support, beyond those defined via `@versioned`. This is useful when you want the generated SDK to expose versions that aren't yet fully annotated in the TypeSpec service definition.
...
// Define the complete set of API versions the client should support,
// including an additional version beyond what's in the service spec.
enum ClientVersions {
  v2023_01_01: "2023-01-01",
  v2024_01_01: "2024-01-01",
  v2024_06_01: "2024-06-01",
...
@@clientApiVersions(WidgetService, ClientVersions);
```

```python
# Python handles API versions at the client configuration level.
# The extra version "2025-01-01" is available as a client option.
client = WidgetServiceClient(endpoint=..., credential=..., api_version="2025-01-01")
```

```csharp
// C# includes all four versions in the ServiceVersion enum
public enum ServiceVersion
{
    V2023_01_01 = 1,
    V2024_01_01 = 2,
    V2024_06_01 = 3,
    V2025_01_01 = 4  // extra version from @clientApiVersions
}

// Latest version defaults to 2025-01-01
public partial class WidgetServiceClientOptions
{
...
```typescript
export enum KnownClientVersions {
  V20230101 = "2023-01-01",
  V20240101 = "2024-01-01",
  V20240601 = "2024-06-01",
  V20250101 = "2025-01-01", // extra version from @clientApiVersions
}
```
...
public enum WidgetServiceVersion implements ServiceVersion {
    ...
    // Note: Java emitter may not yet include additional client API versions
    public static WidgetServiceVersion getLatest() {
        return V2024_06_01;
    }
}
```
