...
## Adding Client API Versions with `@clientApiVersions`

The `@clientApiVersions` decorator lets you add extra API versions to a client beyond those defined in `@versioned`. This is useful when a client should expose preview or additional versions that are not part of the main service versioning enum.
...
@@clientApiVersions(WidgetService, ExtraVersions);
```

```python
# The client now supports the extra version in addition to the @versioned ones
# Available versions: 2023-01-01, 2024-01-01, 2024-06-01-preview
```

```csharp
// The client now includes the additional version
// Available versions: 2023-01-01, 2024-01-01, 2024-06-01-preview
```
...
```java
// The client service version enum includes the additional version
// Available versions: V2023_01_01, V2024_01_01, V2024_06_01_PREVIEW
```
