...
- **Encryption**: Customer-managed key encryption support for the resource.
- **ExtendedLocation**: Support for extended locations (Azure Edge Zones and Custom Locations).
- **AvailabilityZones**: Support for availability zones for the resource.
...
Customer-managed key encryption support for the resource. To enable encryption support, add the `EncryptionProperty` standard envelope property to the resource properties model:
...
For more details on ARM encryption configuration, see the `EncryptionConfiguration` model in the reference docs.

### Extended Location

Support for extended locations (Azure Edge Zones and Custom Locations). To enable extended location support, add the `ExtendedLocationProperty` standard envelope property to the resource definition:
...
Support for availability zones for the resource. To enable zone support, add the `AvailabilityZonesProperty` standard envelope property to the resource definition:
