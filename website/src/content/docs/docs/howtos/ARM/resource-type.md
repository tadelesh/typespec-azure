...
You can find samples of Tenant Resources [in the Tenant Resource sample](https://github.com/Azure/typespec-azure/blob/main/packages/samples/specs/resource-manager/resource-types/tenant/main.tsp).
...
You can find samples of Child Resources [in the Tracked Resource sample](https://github.com/Azure/typespec-azure/blob/main/packages/samples/specs/resource-manager/resource-types/tracked/main.tsp).
...
You can find samples of Subscription Resources [in the ARM Library sample](https://github.com/Azure/typespec-azure/blob/main/packages/samples/specs/resource-manager/arm-library/ref-library/op-templates.tsp).
...
`@tenantResource`: designates this resource as being a cross-tenant resource, with scope across all customer subscriptions in the tenant.
`...ResourceNameParameter<EmployeeAgreementResource>`: spreads in the standard resource name parameter. For a singleton, the name value will always be the same.
...
Support for extended locations such as edge zones and custom locations. To add extended location support, add the `ExtendedLocationProperty` envelope property to the resource definition:
...
Support for customer-managed key encryption configuration for the resource. To add encryption support, add the `EncryptionProperty` envelope property to the resource definition:
...
Support for availability zone configuration for the resource. To add availability zone support, add the `AvailabilityZonesProperty` envelope property to the resource definition:
