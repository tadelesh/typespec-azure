...
### Azure_ClientGenerator_Core_ClientApiVersions_getResource

- Endpoint: `get /azure/client-generator-core/client-api-versions/resource`

Test that @clientApiVersions extends the client's API version enum to include
additional versions beyond those defined in @versioned.

The service defines versions 2024-01-01 and 2024-07-01 via @versioned.
The client extends this with 2023-01-01 and 2023-07-01 using @clientApiVersions.

Expected client API version enum to contain: 2023-01-01, 2023-07-01, 2024-01-01, 2024-07-01.

Expected request:

- GET /azure/client-generator-core/client-api-versions/resource
...
### Azure_ClientGenerator_Core_ClientDoc_getWidget

- Endpoint: `get /azure/client-generator-core/client-doc/widget`

Test that @clientDoc with DocumentationMode.replace replaces the original documentation,
and @clientDoc with DocumentationMode.append appends to the original documentation.

Expected request:

- GET /azure/client-generator-core/client-doc/widget?name=sample

Expected response body:

```json
{ "name": "sample", "color": "blue" }
```
...
### Azure_ClientGenerator_Core_ProtocolApi_both

- Endpoint: `get /azure/client-generator-core/protocol-api/both`
...
### Azure_ClientGenerator_Core_ProtocolApi_convenienceOnly

- Endpoint: `get /azure/client-generator-core/protocol-api/convenienceOnly`
...
### Azure_ClientGenerator_Core_ProtocolApi_protocolOnly

- Endpoint: `get /azure/client-generator-core/protocol-api/protocolOnly`
...
### Azure_ClientGenerator_Core_ResponseAsBool_doesNotExist

- Endpoint: `head /azure/client-generator-core/response-as-bool/doesNotExist`

Test that a HEAD operation decorated with @responseAsBool returns false for 404.
When the resource does not exist, the service returns 404 and the client should return false.

Expected request:

- HEAD /azure/client-generator-core/response-as-bool/doesNotExist

Expected response:

- Status code: 404
- Client return value: false (no error raised)
...
When the resource exists, the service returns 204 and the client should return true.
