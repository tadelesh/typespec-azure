...
### Azure_ClientGenerator_Core_ClientApiVersions_get

- Endpoint: `get /azure/client-generator-core/client-api-versions/get`

Test that the client exposes additional API versions specified by @clientApiVersions.
The service defines only v2024_01_01, but the client should also expose v2023_01_01 and v2023_06_01.

Expected query parameter: api-version="2024-01-01"
...
Test that a HEAD operation decorated with @responseAsBool returns true for a 200 response.

Expected path parameter:
id: "existing"

Expected response: 200 (client should return true)

### Azure_ClientGenerator_Core_ResponseAsBool_notExists

- Endpoint: `head /azure/client-generator-core/response-as-bool/not-exists/{id}`
...
Expected response: 404 (client should return false, not throw an error)

### Azure_ClientGenerator_Core_Scope_allLanguages

- Endpoint: `get /azure/client-generator-core/scope/all-languages`

Test that an operation with @scope("!csharp") is excluded from C# but available for all other languages.

Expected response: 204 No Content

### Azure_ClientGenerator_Core_Scope_getModel

- Endpoint: `get /azure/client-generator-core/scope/model`

Test that a model property with @scope is only included for the specified languages.
