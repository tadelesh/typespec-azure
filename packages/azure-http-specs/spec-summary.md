...
A 200 response should return true, and a 404 response should return false (without raising an error).

For the 'exists' operation:

- HEAD /azure/client-generator-core/response-as-bool/exists with id="existing" should return true (200).
- HEAD /azure/client-generator-core/response-as-bool/exists with id="non-existing" should return false (404).

### Azure_ClientGenerator_Core_Scope_ScopedOperations

- Endpoints:
  - `get /azure/client-generator-core/scope/all`
  - `get /azure/client-generator-core/scope/csharpOnly`

Test that the @scope decorator correctly filters operations by language.
The 'scopedOperation' is scoped to "csharp" only. Other emitters should NOT generate this operation.
The 'allScopesOperation' has no scope and should be generated by all emitters.

For 'allScopesOperation':
