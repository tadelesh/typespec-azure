...
### Azure_ClientGenerator_Core_ClientDoc_getShape

- Endpoint: `get /azure/client-generator-core/client-doc/shape`

Test that the @clientDoc decorator overrides documentation in generated code.
The Shape model documentation should be replaced with custom text.
...
### Azure_ClientGenerator_Core_DisablePageable_listItems

- Endpoint: `get /azure/client-generator-core/disable-pageable/items`

Test that a list operation decorated with @disablePageable is treated as a basic operation
instead of a pageable one. The generated client should return the full ItemListResult model
rather than a paged iterator of Item objects.
...
### Azure_ClientGenerator_Core_MarkAsPageable_listItems

- Endpoint: `get /azure/client-generator-core/mark-as-pageable/items`

Test that a regular GET operation decorated with @markAsPageable is treated as a pageable operation.
The response model has @pageItems on the items property. The generated client should return
a paged iterator of Item objects.
...
- Endpoint: `head /azure/client-generator-core/response-as-bool/resources/{resourceId}`

Test that a HEAD operation decorated with @responseAsBool returns a boolean.
A 2xx response should map to true, and a 404 response should map to false.

For the 'exists' case:
Expected status code: 204
Expected SDK return: true

For the 'notFound' case:
Expected status code: 404
Expected SDK return: false
