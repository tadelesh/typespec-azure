...
- Endpoint: `get /azure/client-generator-core/client-doc/append/get`

Test that @clientDoc with append mode generates the appended documentation.
Expected response body:
...
- Endpoint: `get /azure/client-generator-core/client-doc/replace/get`

Test that @clientDoc with replace mode generates the replacement documentation.
Expected response body:
...
- Endpoint: `head /azure/client-generator-core/response-as-bool/doesNotExist/{id}`

Test that a HEAD operation decorated with @responseAsBool returns false for 404 responses.
Expected path parameter: id="non-existent-resource"
Expected response: 404 with empty body, client should return false (no error raised).

### Azure_ClientGenerator_Core_ResponseAsBool_Exists

- Endpoint: `head /azure/client-generator-core/response-as-bool/exists/{id}`

Test that a HEAD operation decorated with @responseAsBool returns true for 2xx responses.
Expected path parameter: id="test-resource"
Expected response: 200 with empty body, client should return true.

### Azure_ClientGenerator_Core_Scope_AllLanguages

- Endpoint: `get /azure/client-generator-core/scope/allLanguages/get`

Test that an operation without @scope is generated for all languages.
Expected response body:
...
### Azure_ClientGenerator_Core_Scope_Excluded

- Endpoint: `get /azure/client-generator-core/scope/excluded/get`

Test that an operation with @scope("!csharp") is generated for all languages except C#.
Expected response body:

```json
{ "id": "3", "name": "excluded-widget" }
```

### Azure_ClientGenerator_Core_Scope_PythonOnly

- Endpoint: `get /azure/client-generator-core/scope/pythonOnly/get`

Test that an operation with @scope("python") is only generated for Python.
Expected response body:

```json
{ "id": "2", "name": "python-widget" }
```
