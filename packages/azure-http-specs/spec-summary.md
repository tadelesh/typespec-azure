...
### Azure_ClientGenerator_Core_ClientDoc_Append

- Endpoint: `post /azure/client-generator-core/client-doc/append/model`

This scenario tests the `@clientDoc` decorator with `DocumentationMode.append`.
The generated model documentation should append client-specific documentation
to the service-level documentation.
...
### Azure_ClientGenerator_Core_ClientDoc_Replace

- Endpoint: `post /azure/client-generator-core/client-doc/replace/model`

This scenario tests the `@clientDoc` decorator with `DocumentationMode.replace`.
The generated model documentation should use the client-specific documentation
instead of the service-level documentation.
Expected request body:
...
- Endpoint: `get /azure/client-generator-core/convenient-api/both/get`

This scenario tests the default behavior where both protocol and convenient methods are generated.
Expected query parameter: name="sample"
Expected response body:
...
- Endpoint: `get /azure/client-generator-core/convenient-api/convenientOnly/get`

This scenario tests an operation with only convenient API generation.
The operation has `@protocolAPI(false)` so only the convenience method should be generated.
Expected query parameter: name="sample"
Expected response body:
...
- Endpoint: `get /azure/client-generator-core/convenient-api/protocolOnly/get`

This scenario tests an operation with only protocol API generation.
The operation has `@convenientAPI(false)` so only the protocol method should be generated.
Expected query parameter: name="sample"
Expected response body:
...
This scenario tests a HEAD operation decorated with `@responseAsBool`.
The generated client method should return `bool` instead of a raw response.

- A 200 response should return `true`.
- A 404 response should return `false`.

Test case 1: Resource exists (returns true)
Expected path parameter: name="existing"
Expected response: 200 (method returns true)

Test case 2: Resource does not exist (returns false)
Expected path parameter: name="missing"
Expected response: 404 (method returns false, no error raised)

### Azure_ClientGenerator_Core_Scope_AllLanguages

- Endpoint: `get /azure/client-generator-core/scope/allLanguages/get`

This scenario tests an operation that is available in all languages (no scope restriction).
Expected query parameter: name="sample"
Expected response body:
...
### Azure_ClientGenerator_Core_Scope_ExcludedFromSpecificLanguages

- Endpoint: `get /azure/client-generator-core/scope/excludedFromSpecificLanguages/get`

This scenario tests an operation excluded from specific languages using `@scope("!csharp, !go")`.
The operation should be generated for all languages except C# and Go.
Expected query parameter: name="sample"
Expected response body:
...
### Azure_ClientGenerator_Core_Scope_ScopedToSpecificLanguages

- Endpoint: `get /azure/client-generator-core/scope/scopedToSpecificLanguages/get`

This scenario tests an operation scoped to only specific languages using `@scope("java, python")`.
The operation should only be generated for Java and Python emitters.
